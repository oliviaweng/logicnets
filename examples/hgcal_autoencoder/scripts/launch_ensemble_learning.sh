...
tmux new-session -d -s ph00 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/averaging/large_polylut_shared_io_configs/config1 ./averaging"
# tmux new-session -d -s ph01 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/averaging/large_polylut_shared_io_configs/config2 ./averaging"
# tmux new-session -d -s ph02 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/averaging/large_polylut_shared_io_configs/config3 ./averaging"
