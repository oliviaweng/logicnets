...
tmux new-session -d -s g00 "./scripts/run_sml_grid_search_exp.sh 0 ./grid_search_configs/weak1_configs"
tmux new-session -d -s g01 "./scripts/run_sml_grid_search_exp.sh 0 ./grid_search_configs/weak2_configs"
