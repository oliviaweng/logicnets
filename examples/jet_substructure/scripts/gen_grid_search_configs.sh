...
python3 grid_search.py -c search_configs/jsc_l_ensemble_grid_search.yml -d ./ensemble_configs/averaging/large_shared_input_output_layers --experiment_prefix medium_shared_input_output_layers
