...
# tmux new-session -d -s jscm_avg00 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/averaging/medium_qavg ./averaging"
# tmux new-session -d -s jscl_avg00 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/averaging/large_qavg ./averaging"
...
# Bagging
tmux new-session -d -s jscs_bag00 "./scripts/run_gen_ensemble_exp.sh 0 ./ensemble_configs/bagging/small_configs./bagging"