...
# Bagging
tmux new-session -d -s bag "./scripts/run_train_exp.sh 1 ./ensemble_configs/bagging/jsc_xl_deg2 ./bagging"

# AdaBoost
tmux new-session -d -s ada "./scripts/run_train_exp.sh 1 ./ensemble_configs/adaboost/jsc_xl_deg2 ./adaboost"
